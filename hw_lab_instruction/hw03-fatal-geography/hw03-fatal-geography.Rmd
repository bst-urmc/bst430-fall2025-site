...
8.  Derive the fatalities per 100,000 population divided by vehicle miles traveled (average per person), in each county, using the crash count table from  Ex 3 and 5.  Repeat your plot from Ex 5 (though now you will only have <s>16</s> 17 counties).  Discuss your findings.
