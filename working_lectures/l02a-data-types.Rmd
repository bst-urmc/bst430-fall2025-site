...
knitr::include_graphics("l02/img/mean-help.png")
```
...
*  `str` is *nearly* a synonym for `dplyr::glimpse`
...
.footnote[There are also `NA\_integer\_`, `NA\_real\_` and `NA\_character\_`, occasionally needed to avoid warnings or errors about unplanned coercions.]
---
...
**Meatspace elements**
* hydrogen
<img src = "l02/img/320px-Hydrogen_discharge_tube.jpg" width = "48%">
* carbon
<img src = "l02/img/Graphite-and-diamond-with-scale.jpg" width = "48%">
* uranium
<img src = "l02/img/600px-HEUraniumC.jpg" width = "48%">
]
...
**Meatspace compounds**
*  $H_2O$
<img src = "l02/img/640px-Ice_Block.jpg" width = "50%">
*  NaCl
<img src = "l02/img/640px-Salt_Farmers.jpg" width = "50%">
*  $C_8H_{10}N_4O_2$
<img src = "l02/img/640px-A_small_cup_of_coffee.jpeg" width = "50%">
]
