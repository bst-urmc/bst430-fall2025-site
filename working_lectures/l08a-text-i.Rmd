...
Here's the [R code in this lecture](l08/text.R)

Here's the [cardiac-dx](l08/data/cardiac-dx.csv) and 
[sample_sheet2](l08/ae/data/sample_sheet2.csv)
...
```{r, output.lines = 13}
diagnoses = read_csv('l08/data/cardiac-dx.csv')
diagnoses
```
...
Read some data
```{r read-samplesheet}
data = read_csv("l08/ae/data/sample_sheet2.csv")
data
```
---
