...
Here's the [R code in this lecture](l12/linear-models.R)

and the [auction dataset](l12/data/paris-paintings.csv)
...
```{r message=FALSE}
pp = read_csv("l12/data/paris-paintings.csv", na = c("n/a", "", "NA"))
```
...
knitr::include_graphics("l12/img/old-auction.png")
```
...
knitr::include_graphics("l12/img/auction-trend-paris.png")
```
...
```{r out.width="65%", echo=FALSE}
knitr::include_graphics("l12/img/depart-pour-la-chasse.png")
```
...
.pull-left[
```{r out.width="60%", echo=FALSE}
knitr::include_graphics("l12/img/auction-catalogue.png")
```
]
.pull-right[
.small[
...
knitr::include_graphics("l12/img/painting1.png")
knitr::include_graphics("l12/img/painting2.png")
knitr::include_graphics("l12/img/painting3.png")
```
...
```{r height-width-plot, fig.show="hide", warning=FALSE}
...
knitr::include_graphics("l12/img/tidymodels.png")
```
...
knitr::include_graphics("l12/img/cell_phones.png")
```
