...
Here's the [R code in this lecture](l12/prediction-logistic.R)
...
```{r echo=TRUE, evval = FALSE, out.width="75%", fig.width=10}
...
knitr::include_graphics("l12/img/cross-validation.png")
```
...
.pull-right[
```{r echo=FALSE, out.width="100%", fig.align="right"}
knitr::include_graphics("l12/img/cross-validation-animated.gif")
```
]
