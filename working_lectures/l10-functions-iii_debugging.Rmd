...
author: "Don Harrington, based on the course by Andrew McDavid and Tanzy Love"
...
Here's the [R code in this lecture](l10/debugging.R)
...
```{r, echo = FALSE}
knitr::include_graphics('l10/img/knitr-clear-cache.png')
```
...
```{r, echo = FALSE}
knitr::include_graphics('l10/img/debugging.png')
```
