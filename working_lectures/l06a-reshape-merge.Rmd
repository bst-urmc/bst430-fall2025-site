...
Here's the [R code in this lecture](https://github.com/seonghwanjun/bst430-fall2025-l05/blob/main/reshape-merge.R)

Here's the [customers](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/sales/customers.csv),
 [prices](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/sales/prices.csv),
 [biden](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/trump/biden.csv),
 [professions](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/scientists/professions.csv),
 [dates](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/scientists/dates.csv),
 [works](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/scientists/works.csv),
 [enrollment](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/students/enrolment.csv),
 [survey](https://github.com/seonghwanjun/bst430-fall2025-l05/tree/main/data/students/survey.csv)
...
* `nest()` and `unnest()` let you embed or expand list columns in a data frame. 
...
```{r}
gapminder |>
  mutate(gdp_level = if_else(gdpPercap > 30000, "High GDP", "Low GDP")) |> 
  nest(data = -c(continent, gdp_level))
```
...
How does `nest` differ from `group_by`? Go over the vignette: [here](https://tidyr.tidyverse.org/articles/nest.html).

- `group_by` is implicit -- it adds an attribute to manage grouping.
- `nest` explicitly splits the data.
...
gapminder |>
  mutate(gdp_level = if_else(gdpPercap > 30000, "High GDP", "Low GDP")) |> 
  group_by(continent, gdp_level) |>
  nest()
```

- We will later see powerful use cases of `nest`.
...
```{r}
nested_data <- gapminder |> nest(data=-continent)
nested_data

nested_data |> unnest(cols = data)
```
...
[code](https://github.com/seonghwanjun/bst430-fall2025-l05/blob/main/flights_join.R)
...
[1](https://datasciencebox.org/course-materials/_slides/u2-d09-tidying/u2-d09-tidying#1)
[2](https://datasciencebox.org/course-materials/_slides/u2-d08-multi-df/u2-d08-multi-df#1)
