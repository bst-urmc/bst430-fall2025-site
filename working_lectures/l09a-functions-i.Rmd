...
Here's the [R code in this lecture](l09/functions-i.R)
...
ggplot( gapminder, aes(x = year, y = lifeExp, color = continent))  + 
  ...
  geom_boxplot( aes(group = interaction(year,continent)), 
    data = filter(gapminder, year %in% seq(from=1952, to = 2002, by = 20)), 
    fill = 'grey', width = 8, outlier.shape = NA, position = 'dodge') 
```
...
knitr::include_graphics("l09/img/spotify-howtobuildmvp.jpg")
```
...
max_minus_min(gapminder$country) ## factors are kind of like integer vectors?
...
url = "https://www.gov.scot/publications/coronavirus-covid-19-update-first-ministers-speech-23-october/"
speech_page = read_html("l09/data/oct-23.html")
```
...
knitr::include_graphics("l09/img/fm-speech-oct-23.png")
```
...
knitr::include_graphics("l09/img/funct-all-things.png")
```
]
--
.pull-right[
...
Reading:
[R4ds Functions](https://r4ds.hadley.nz/functions.html)
