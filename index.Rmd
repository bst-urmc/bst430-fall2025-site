...
10. Finish vizualization slides
...
12. [Text analysis](lecture/l10-text-ii.html)    [video link](https://rochester.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=3482b784-14f4-4ff0-8634-af3201202cb5)
    *  [Lab 5](hw_lab_instruction/lab05-sadplots/lab05-sadplots.html).  Pair up; take turns and then you won't have so many GitHub problems.
    [Invitation here](https://classroom.github.com/a/sFi-IjD6). Due 5pm, Oct 25.
    *  Reading: [r4ds chapter 14](https://r4ds.had.co.nz/strings.html)
<!--     *  Discuss lab 5.   -->
<!-- 13. Finish text processing slides. -->
13-14. [Matrices, indexing, linear algebra](lecture/l11-linear-algebra-indexing.html)
    * Finish Lab 5
...
<!--    * HW 4 assigned.  [instructions](hw_lab_instruction/hw05-modeling-gss/hw-04-modeling-gss.html) and repo (accept GH classroom [invite](https://classroom.github.com/a/)).  Due 5pm EDT, Nov 18 (but feel free to finish it before the final exam). -->
...
16. [Functions ii and iteration](lecture/l13-functions-ii.html).
    *   [Lab 6](hw_lab_instruction/lab06-covid-times/lab06-covid-times.html) assigned, any groups as you like.
    [Invitation here](https://classroom.github.com/a/6GAvWurq). Due 5pm, Nov 16.
<!-- 18.  [Knitr tricks and debugging](lecture/l14-debugging.html).  -->
<!-- [Lab 07](hw_lab_instruction/lab07-generative-art/lab07-generative-art.html) due 5PM Nov 12.  [Lab 07 notes](lecture/lab07-art-notes.html). -->
