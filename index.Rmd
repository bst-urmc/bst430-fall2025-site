...
<!-- * Final Exam. Remember I will be looking at the `.md` for results and the `.Rmd` for your code. [instructions](hw_lab_instruction/final-modeling.html) and repo (accept GH classroom [invite](https://classroom.github.com/a/eebbYmkV)).  Due 5pm EDT, Nov 8. -->
<!-- 21.  [Ensemble models](lecture/l20-trees-and-forests.html) -->
