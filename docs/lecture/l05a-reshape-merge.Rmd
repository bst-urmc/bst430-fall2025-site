...
Here's the [R code in this lecture](l05/l05a-reshape-merge.R)

Here's the [customers](l05a/data/sales/customers.csv)
and [prices](l05a/data/sales/prices.csv)
and [biden](l05a/data/trump/biden.csv)
